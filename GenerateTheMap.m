function [map,bandsize,number]=GenerateTheMap(image)
%%image is a struct, containing the information of name, image(512*512),
%%peaks(lambda), threshold, peakvalue(relative grayscale), peakloc(peaks location regarding 512)
