...
[maptilted,bandsize,number,long]=GenerateTheTiltedMap(calimage,5);
maptilted=floor(maptilted);
%%map=imrotate(map(:,:,2),-5);
...
t1=clock;
stack=ReadSpectralImages(imagepath,imagename,channels,offset,maptilted,bandsize,number,5,long);
t2=clock;
a=etime(t2,t1);
